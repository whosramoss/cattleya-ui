...
1. **[GitHub Security Advisories](https://github.com/whosramoss/cattleya-ui/security/advisories/new)** (preferred) — private report on the repository.
2. Contact the maintainer via the email listed on the [npm package page](https://www.npmjs.com/package/cattleya-ui) if you cannot use GitHub.
...
Out of scope: vulnerabilities in the demo site hosting, third-party CDNs, or consumer applications that embed `cattleya-ui` incorrectly.
