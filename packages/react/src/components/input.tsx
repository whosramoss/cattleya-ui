...
export function Input({
  ...
  return (
    <div
      className={cn(
        'relative inline-flex h-11 w-64 items-center overflow-hidden rounded-xl border border-border bg-main-secondary transition-colors ease-out focus-within:border-primary/20 data-[filled=true]:border-border',
